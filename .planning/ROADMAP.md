...
- [ ] 40-03-PLAN.md — Alt paint combobox in step row + alt paint display in timeline + add-all-missing-to-wishlist button
...
| 40. Recipe Actions + Step Photos | v2.5 | 0/3 | Not started | - |

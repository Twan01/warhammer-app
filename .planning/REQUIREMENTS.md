...
- [x] **ARMY-02**: User can view the selected detachment's ability in the army list detail
- [x] **ARMY-03**: User can view relevant stratagems for the selected detachment in the army list
- [x] **ARMY-04**: User sees a stale-data warning when army list uses rules data older than 30 days
- [x] **ARMY-05**: User can view list-level rules reminders (user-marked favorites from Playbook)

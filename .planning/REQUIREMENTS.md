...
- [ ] **SECT-01**: User can see recipe sections stored in a new recipe_sections table (id, recipe_id, name, surface, optional, order_index, notes, timestamps)
- [ ] **SECT-02**: User's existing recipe steps gain a section_id FK linking them to their section
- [ ] **SECT-03**: User's existing recipes are auto-migrated with one default section per recipe, all steps pointed at it (zero data loss)

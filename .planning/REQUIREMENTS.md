...
- [x] **INT-01**: PlaybookTab shows canonical unit stats, weapons, and abilities from udb_* tables (replacing null stub)
- [x] **INT-02**: Game Day UnitAbilityCard shows weapon profiles from canonical database in a collapsible section
...
- [x] **FR-04**: App shows EN/FR locale toggle (persisted to localStorage), switching all canonical data display language
- [x] **FR-05**: FTS5 search index includes French names for bilingual search
...
| INT-01 | Phase 110 | Complete |
| INT-02 | Phase 110 | Complete |
...
| FR-04 | Phase 111 | Complete |
| FR-05 | Phase 111 | Complete |

...
- [ ] **DAS-02**: Canonical `udb_*` schema in hobbyforge.db with tables for units, models, weapons, abilities, keywords, points tiers, composition
...
- [ ] **DAS-07**: FTS5 full-text search virtual table for cross-faction unit search

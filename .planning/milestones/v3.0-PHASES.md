# HobbyForge — Phase Index (v2.5+)

This file is a lightweight index. Each milestone has its own roadmap file.

| Version | Name | Phases | File | Status |
|---------|------|--------|------|--------|
| v2.5 | Recipes 2.0 / Painting Studio | 37–41 | `v2.5-ROADMAP.md` | In Progress |
| v2.6 | Rules Sync 2.0 / Rules Data Hub | 42–46 | `v2.6-ROADMAP.md` | Planned |
...
```
v2.5 (37-41)  Recipes 2.0           ← IN PROGRESS
     ↓
v2.6 (42-46)  Rules Sync 2.0        ← foundation for all rules-dependent features
     ↓
v2.7 (47-50)  Army Lists 2.0        ← needs rules data from v2.6
     ↓

...
- 🚧 **v0.2.5 Recipes 2.0 / Painting Studio** — Phases 37–41 (in progress)
- 📋 **v0.2.6 Rules Sync 2.0 / Rules Data Hub** — Phases 42–46 (planned)
- 📋 **v2.7 Points & Army Lists 2.0** — Phases 47–50 (planned)
- 📋 **v2.8 Game Day Mode** — Phases 51–53 (planned)
- 📋 **v2.9 Battle Intelligence 2.0** — Phases 54–57 (planned)
- 📋 **v2.10 Smart Planning / Next Best Action** — Phases 58–59 (planned)
- 📋 **v2.11 Smart Wishlist / Budget Optimizer** — Phases 60–61 (planned)
...
### v0.2.5 Recipes 2.0 / Painting Studio (In Progress)
...
**Goal**: The recipe data model is rebuilt on a structured step foundation, existing data is preserved, and two pre-existing bugs that would corrupt the v0.2.5 experience are eliminated before any new UI lands
**Depends on**: Phase 36 (v0.2.4 complete)

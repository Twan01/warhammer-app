# Requirements Archive: v0.1.1 HobbyForge MVP
...
Milestone v0.1.1 — Utility Layer. Paint Inventory UI + Army List Builder + Unit Playbook.
...
| PINV-01 | Phase 6 (v0.1.1) | Pending |
| PINV-02 | Phase 6 (v0.1.1) | Pending |
| PINV-03 | Phase 6 (v0.1.1) | Pending |
| PINV-04 | Phase 6 (v0.1.1) | Pending |
| PINV-05 | Phase 6 (v0.1.1) | Pending |
| PINV-06 | Phase 6 (v0.1.1) | Pending |
| ARMY-01 | Phase 7 (v0.1.1) | Pending |
| ARMY-02 | Phase 7 (v0.1.1) | Pending |
| ARMY-03 | Phase 7 (v0.1.1) | Pending |
| ARMY-04 | Phase 7 (v0.1.1) | Pending |
| ARMY-05 | Phase 7 (v0.1.1) | Pending |
| ARMY-06 | Phase 7 (v0.1.1) | Pending |
| ARMY-07 | Phase 7 (v0.1.1) | Pending |
| STRAT-01 | Phase 8 (v0.1.1) | Pending |
| STRAT-02 | Phase 8 (v0.1.1) | Pending |
| STRAT-03 | Phase 8 (v0.1.1) | Pending |
| STRAT-04 | Phase 8 (v0.1.1) | Pending |
| STRAT-05 | Phase 8 (v0.1.1) | Pending |
| STRAT-06 | Phase 6 (v0.1.1) | Pending |

**Coverage:**
- v1.0 requirements: 83 total — all mapped, all complete
- v0.1.1 requirements: 20 total — mapped to phases 6–8, pending
- Unmapped: 0 ✓

---
*Requirements defined: 2026-04-30*
*Last updated: 2026-05-01 — v0.1.1 requirements added (PINV, ARMY, STRAT); SUGG/BTL/IMG/BAK deferred to v1.2+*

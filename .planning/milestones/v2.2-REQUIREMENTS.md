...
- [x] **WISH-01**: User can add a wishlist item with a name, faction, and optional estimated cost in pence
- [x] **WISH-02**: User can view all wishlist items on a dedicated page
- [x] **WISH-03**: User can delete a wishlist item
- [x] **WISH-04**: User can add optional notes to a wishlist item (e.g. "wait for sale", "for Crusade roster")

### Analytics

- [x] **ANLY-01**: User can create a painting goal with a target unit count and timeframe (this month / this quarter)
- [x] **ANLY-02**: Goal progress is calculated by counting distinct units with at least one painting session during the goal period
- [x] **ANLY-03**: User can view all active and completed goals with a progress bar
...
- [x] **DISP-01**: Collection page has a "Battle Ready" quick-filter showing only fully-painted and assembled units
- [x] **DISP-02**: User can enter Showcase Mode to view all painted units in a full-screen gallery with app chrome hidden
- [x] **DISP-03**: User can exit Showcase Mode to return to the normal app view
...
| WISH-01 | Phase 21 | Complete |
| WISH-02 | Phase 21 | Complete |
| WISH-03 | Phase 21 | Complete |
| WISH-04 | Phase 21 | Complete |
| ANLY-01 | Phase 22 | Complete |
| ANLY-02 | Phase 22 | Complete |
| ANLY-03 | Phase 22 | Complete |
| DISP-01 | Phase 23 | Complete |
| DISP-02 | Phase 23 | Complete |
| DISP-03 | Phase 23 | Complete |

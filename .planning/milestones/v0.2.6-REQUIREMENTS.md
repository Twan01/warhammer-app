# Requirements Archive: v0.2.6 Rules Sync 2.0 / Rules Data Hub
...
# Requirements: HobbyForge v0.2.6
...
Requirements for v0.2.6 Rules Sync 2.0 / Rules Data Hub. Each maps to roadmap phases.

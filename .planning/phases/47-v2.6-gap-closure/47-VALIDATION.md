...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 47-01-01 | 01 | 1 | OVRD-06 | unit | `pnpm test -- tests/datasheet/computeSyncDiff.test.ts` | ✅ (extend) | ⬜ pending |
| 47-01-02 | 01 | 1 | OVRD-06 | unit | `pnpm test -- tests/datasheet/computeSyncDiff.test.ts` | ✅ (extend) | ⬜ pending |
| 47-01-03 | 01 | 1 | OVRD-06 | unit | `pnpm test -- tests/datasheet/computeSyncDiff.test.ts` | ✅ (extend) | ⬜ pending |

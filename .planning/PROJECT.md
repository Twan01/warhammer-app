...
## Current Milestone: v0.7.0 Technique Library
...
## Last Shipped Milestone: v0.6.0 Bulletproof & Honest (shipped 2026-06-19)
...
*Milestone v0.7.0 Technique Library in definition — reusable, slot-parameterized, live-linked painting techniques (see Current Milestone above). Requirements being scoped via `/gsd-new-milestone`. Candidate carry-overs (not in this milestone): PLAY-FUT-01 (faction overview page), PLAY-FUT-02 (auto-backup on schedule), HON-FUT-01 (theme customization / custom painting-status labels), French translations for stratagems/enhancements.*

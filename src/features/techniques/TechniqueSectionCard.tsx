...
import { RECIPE_SURFACES } from "@/features/recipes/recipeSchema";
import type { DraftTechniqueSection, DraftTechniqueSlot } from "@/types/technique";
import { TechniqueStepList } from "./TechniqueStepList";

interface TechniqueSectionCardProps {
  section: DraftTechniqueSection;
  slots: DraftTechniqueSlot[];
  onChange: (updated: DraftTechniqueSection) => void;
  onRemove: () => void;
}

export function TechniqueSectionCard({
  section,
  slots,
  onChange,
  onRemove,
}: TechniqueSectionCardProps) {

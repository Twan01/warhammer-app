 ...
 *
 * Responsive grid of 4 StatCard instances showing row counts for key
 * tables: Units, Recipes, Assignments, Step Progress.
 * Loading state renders 4 skeleton cards matching the StatCard layout.
 */

 ...
 *
 * Relocated from src/features/recipes/recipeDiff.ts to src/lib/ so the query
 * layer (src/db/queries/recipes.ts) can import it without crossing the feature
 * boundary. No async logic, no DB calls, no React.
 */

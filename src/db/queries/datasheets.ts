...
// ---------------------------------------------------------------------------
// Unit keyword status (Phase 91 — ENH-02)
// ---------------------------------------------------------------------------

/**
 * Result of checking a unit's keywords for Character / Epic Hero status.
 * Used by the EnhancementPickerSheet to determine eligibility.
 */

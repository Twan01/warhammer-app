 ...
 * - Data state: renders list name, points, unpainted count
 * - Warning badge when unpainted > 0
 * - Sorts by updated_at DESC (uses most recently updated list)
 * - No sync/freshness row (Phase 133: sync row removed)
 */
...
describe("ReadyToPlayCard — data rendering", () => {
  ...
  it("does not show any sync/freshness/stale text (Phase 133: sync row removed)", () => {
    render(<ReadyToPlayCard />);

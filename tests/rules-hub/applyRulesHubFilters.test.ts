...
function makeStratagem(overrides: Partial<UdbStratagem> = {}): UdbStratagem {
  return {
    id: "s1",
    faction_id: "SM",
    detachment_id: null,
...
const STRATAGEMS: UdbStratagem[] = [
  makeStratagem({ id: "s1", name: "Command Shroud", phase: "Command", cp_cost: 1, type: "use in command phase" }),
  makeStratagem({ id: "s2", name: "Move Move Move", phase: "Movement", cp_cost: 2, type: "advance further" }),
  makeStratagem({ id: "s3", name: "Rapid Fire", phase: "Shooting", cp_cost: 1, type: "double shots" }),
  makeStratagem({ id: "s4", name: "Heroic Charge", phase: "Charge", cp_cost: 2, type: null }),
  makeStratagem({ id: "s5", name: "Death Blow", phase: "Fight", cp_cost: 3, type: "lethal strike" }),
  makeStratagem({ id: "s6", name: "Null Phase", phase: null, cp_cost: 1, type: null }),
];
...
describe("applyStratagemFilters", () => {
  ...
  it("searches by type field — case-insensitive", () => {
